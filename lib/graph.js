...
exports.create = function(graphDatabase) {
	...
	return {
		...
		updateIndex: function(nodeId, index, field, value) {
			var deferred = Q.defer();
			return getNodeById(nodeId)
			.then(function(node) {
		...
		createRelationshipBetween: function(fromNodeId, toNodeId, relationshipType, params) {
			var deferred = Q.defer();
			var fromNode, toNode;
		...
		updateRelationship: function(relationshipId, relationshipData) {
			var deferred = Q.defer();
